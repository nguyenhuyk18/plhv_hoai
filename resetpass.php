...
<title>Lấy Lại Mật Khẩu - Hệ Thống LMS</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-title">
                <h3><i class="fas fa-key" style="color:#667eea;margin-right:10px;"></i>Lấy Lại Mật Khẩu</h3>
            ...
            <form action="sendOTP.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="ma" placeholder="Nhập mã sinh viên" size="26" required="required" />
                    </div>
                </div>
                ...
                <button type="submit" name="kiemtra" class="btn">
