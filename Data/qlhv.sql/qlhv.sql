...
-- 
-- Serveur: localhost
-- Généré le : Sam 16 Décembre 2023 à 10:04
...
(1, 'Phúc Nguyễn Follo', 'Xin Chào ! Mình là Follo là Admin Hệ Thống của website lms này nhé !<br>\r\nHiện tại mình ...', 1);

-- --------------------------------------------------------

-- 
-- Structure de la table `baitaplythuyet`
-- 
...
-- 
-- Contenu de la table `baitaplythuyet`
-- 
...
(5, 'Bài Tập ERP ( Nhóm )', 'BTN_So1.docx', '2023-12-06T15:00', '2023-12-07T15:00', '2023-12-04 17:30:33', 1),
(7, 'Bài Tập ERP ( Làm Cá Nhân )', 'Bai_Tap_Ca_Nhan.docx', '2023-12-07T18:20', '2023-12-08T18:20', '2023-12-06 18:21:00', 1),
(8, 'Bài Tập 1', '19443131_NopBaiKiemTraTH.docx', '2023-12-07T21:47', '2023-12-08T21:47', '2023-12-06 21:48:53', 1);

-- --------------------------------------------------------

-- 
-- Structure de la table `baitapthuchanh`
-- 
...
-- 
-- Contenu de la table `baitapthuchanh`
-- 

INSERT INTO `baitapthuchanh` (`id_btth`, `tieude`, `batdaunop`, `ketthucnop`, `ngaydang`, `loaibai`, `id_giangday`) VALUES 
(1, 'Nộp bài tập TH ERP', '2023-12-06T10:58', '2023-12-10T10:58', '2023-12-06 10:58:36', '', 1),
...
-- 
-- Structure de la table `ct_hocphan`
-- 
...
-- 
-- Contenu de la table `ct_hocphan`
-- 
...
(26, '10', '10', '6', '10', '9', '10', '10', '10', '9.7', 1, 7, 1),
(27, '10', '4', '8', '8', '8', '9', '9', '9', '8.5', 1, 1, 1),
(28, '10', '9', '9', '8', '9', '8', '9', '8', '8.5', 7, 7, 2);

-- --------------------------------------------------------

-- 
-- Structure de la table `dkhp`
-- 
...
-- 
-- Structure de la table `filediem`
-- 
...
-- 
-- Contenu de la table `filenopbtlt`
-- 

INSERT INTO `filenopbtlt` (`id_filenopbtlt`, `tieude`, `filenop`, `ngaynop`, `id_btlt`, `id_sinhvien`) VALUES 
(10, 'Bài Tập Nộp _ Nhóm 1 ( Hoa Sen )', 'HOA_SEN_GROUP.pptx', '2023-12-06 16:28:56', 5, 7);

-- --------------------------------------------------------

-- 
-- Structure de la table `filenopbtth`
-- 
...
-- 
-- Contenu de la table `filenopbtth`
-- 

INSERT INTO `filenopbtth` (`id_filenopbtth`, `tieude`, `filenop`, `ngaynop`, `id_sinhvien`, `id_btth`) VALUES 
(6, '19443131_NguyenVanPhuc_BaiTH_Tuan01', '19443131_NguyenVanPhuc_NopBTTHTuan01_2.zip', '2023-12-06 15:04:05', 7, 1),
(10, '19443131_NGUYENVANPHUC_THKTERP', '19443131_NopBaiKiemTraTH.docx', '2023-12-06 18:05:33', 7, 2);

-- --------------------------------------------------------

-- 
-- Structure de la table `giangday`
-- 
...
(1, 'TT@#123', 'NGUYỄN T X', 'Nam', '0324536212', 'Q1, TP.HCM', 'Thạc Sĩ', 'Đang cập nhật...', 'Cơ Sở 1 ( TP.HCM )', 'Đang cập nhật...', 'Đang cập nhật...', 'Đang cập nhật...', 1, 13),
...
-- 
-- Structure de la table `khoavien`
-- 
...
-- 
-- Structure de la table `lophocphan`
-- 
...
-- 
-- Contenu de la table `lophocphan`
-- 
...
(1, 2, 'NGUYỄN VĂN ANH', 19843211, 'Nam', '2001-07-14', '0324564732', '2023-02-02', 'Tây Ninh', 'Dương Minh Châu, Tây Ninh', 'Tây Ninh', '2019-08-14', '2019-2023', 'DH_CN_A', 'Cơ Sở 1 ( TP.HCM )', 1, 1),
...
-- 
-- Structure de la table `thongketruycap`
-- 
...
-- 
-- Contenu de la table `thongketruycap`
-- 
...
(2, '2023-12-12 18:17:29', 'c4ca4238a0b923820dcc509a6f75849b', 1, 0, 1),
...
(7, '2023-12-12 20:03:50', 'c81e728d9d4c2f636f067f89cc14862c', 7, 0, 1),
(8, '2023-12-12 09:33:41', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 9, 0, 1),
(9, '2023-12-07 16:23:34', 'a87ff679a2f3e71d9181a67b7542122c', 12, 0, 1);
...
(8, 'Tài Liệu ERP', 'BTThucHanh_QUITRINHMUAHANG_SANXUAT_BANHANG_DaLoaiBoThucThi.pptx', '2023-12-06 20:14:41', 'GT', 1),
(10, 'Tài Liệu TH ERP', 'HOA_SEN_GROUP.pptx', '2023-12-06 20:28:17', 'BTTH', 1),
(11, 'Slide ERP', 'HOA_SEN_GROUP.pptx', '2023-12-06 20:36:08', 'Slide', 1);
...
(2, '14a6cee614215777ba6d0c7da6564a1e', 'NVA', 'e10adc3949ba59abbe56e057f20f883e', '0', 'a@gmail.com', '123456543213', 'https://tse3.mm.bing.net/th?id=OIP.muVHXnoxN5sqaWcWPYaP9AHaHa&pid=Api&P=0&h=180', '0'),
(3, '2fed525adfda0d4c12f10aa06969ed52', 'NTC', 'e10adc3949ba59abbe56e057f20f883e', '0', 'cdf@gmail.com', '234543212346', 'https://tse2.mm.bing.net/th?id=OIP.YzD-_W1DbK6T_RJsubfP-AHaHu&pid=Api&P=0&h=180', '0'),
(4, '000afb078ba06cc67f7dc8af85f51653', 'THA', 'e10adc3949ba59abbe56e057f20f883e', '0', 'ngh@gmail.com', '564327891653', 'https://tse1.mm.bing.net/th?id=OIP.qilJV7ubqk5vAxS2OosDpwHaEK&pid=Api&P=0&h=180', '0'),
(5, 'e068ff48f0966deade935517d6b4686a', 'PND', 'e10adc3949ba59abbe56e057f20f883e', '0', 'dscav123@gmail.com', '202134759732', 'https://tse1.mm.bing.net/th?id=OIP.__KSg8Z9Gel4X72iZq7-TQAAAA&pid=Api&P=0&h=180', '0'),
...
(9, '38b32a214ffd3419ef83013be6b49391', 'LTV', 'e10adc3949ba59abbe56e057f20f883e', '0', 'levinh@gmail.com', '123456543212', 'https://tse3.mm.bing.net/th?id=OIP.0DrnRWMVgN8AvQ6Eu9H_hwHaEp&pid=Api&P=0&h=180', '0'),
...
(13, '354f31b1031ca6dddf783514597ab0b2', 'NTT', 'e10adc3949ba59abbe56e057f20f883e', '1', 'ntt@gmail.com', '034521678543', 'https://tse1.mm.bing.net/th?id=OIP.UVTTiTmngViDKz-1ylEfVgHaEK&pid=Api&P=0&h=180', '0'),
