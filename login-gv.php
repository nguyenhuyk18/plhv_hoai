    ...
    <div class="container-custom">
        <div class="logo-section">
            ...
            <div class="school-info">
                ...
                <p>Teacher Learning Management System</p>
            </div>
        </div>
    </div>
</div>
...
<div class="login-container">
    <div class="login-content">
        <div class="login-box">
            <h3>👨‍🏫 Đăng Nhập Giảng Viên</h3>
            
            <form action="dntc.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="username">Mã Giảng Viên</label>
                    <input type="text" id="username" name="a" placeholder="Nhập mã giảng viên" required="required" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="captcha-group">
                        ...
                        <a href="login-gv.php?return" class="refresh-captcha">🔄</a>
                    </div>
                </div>
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section">
                ...
                <p>Nền tảng hiện đại để quản lý và hướng dẫn học tập của học sinh.</p>
            </div>
